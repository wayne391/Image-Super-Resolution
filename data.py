...
class MetaSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.args.need_patch:
            ...
            img_lr_patch, img_hr_patch = getPatch(img_lr, img_hr, self.args, self.scale)
            img_lr_patch, img_hr_patch = augment(img_lr_patch, img_hr_patch)
...
class BenchmarkSet(MetaSet):
    def __init__(self, args, dir_benchmark):
        ...
        self.file_list = [f.replace('HR', 'new')[19:] for f in self.file_list_hr]
